                ...
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                    ...
                    <li class="layui-nav-item">
                        <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-street-view"></i><span
                                    class="layui-left-nav"> 法人客户管理</span> <span class="layui-nav-more"></span></a>
                        <dl class="layui-nav-child">
                            </#if>
                            <#if permissions?seq_contains("2010")>
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-3" data-tab="customer/index" target="_self"><i
                                                class="fa fa-exchange"></i><span
                                                class="layui-left-nav"> 法人客户管理</span></a>
                                </dd>
                            </#if>
                        </dl>
                    </li>

                    <#if permissions?seq_contains("21")>
                    <li class="layui-nav-item">
                        <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-flag"></i><span
                                    class="layui-left-nav"> 自然人客户管理</span> <span class="layui-nav-more"></span></a>
                        <dl class="layui-nav-child">
                            </#if>
                            <#if permissions?seq_contains("2120")>
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-4" data-tab="legalCustomer/index" target="_self"><i
                                                class="fa fa-user-times"></i><span
                                                class="layui-left-nav"> 自然人客户管理</span></a>
                                </dd>
                            </#if>
                        </dl>
                    </li>
                                ...
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-10" data-tab="report/1" target="_self"><i
                                                class="fa fa-tachometer"></i><span
                                                class="layui-left-nav"> 客户角色分析</span></a>
                                </dd>
                            </#if>
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <#if permissions?seq_contains("5040")>
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-10" data-tab="dataDic/index" target="_self"><i
                                                class="fa fa-tachometer"></i><span
                            ...
                            <#if permissions?seq_contains("5050")>
                                <dd class="">
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-14" data-tab="druid/index.html" target="_self"><i
                                                class="fa fa-tachometer"></i><span
