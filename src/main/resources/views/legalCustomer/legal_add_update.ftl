...
<#--        </div>-->
    ...
    <div class="layui-form-item layui-row">
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input"
                       name="cardType" id="cardType"  lay-verify="required" value="${(customer.cardType)!}" placeholder="请输入证件类型">
            </div>
        </div>
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input"
                       name="cardNo" id="cardNo" lay-verify="required" value="${(customer.cardNo)!}" placeholder="请输入证件号码">
            </div>
        </div>
    </div>
